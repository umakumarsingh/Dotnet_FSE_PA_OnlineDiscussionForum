...
namespace OnlineDiscussionForum
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IAdminDiscussionForumRepository, AdminDiscussionForumRepository>();
            services.AddScoped<IAdminDiscussionForumServices, AdminDiscussionForumServices>();
